...
export const shippingAddressSchema = z.object({
  fullName: z.string().min(3, 'Name must be at least 3 charactesrs'),
  streetAddress: z.string().min(3, 'Address must be at leasat 3 characters'),
  city: z.string().min(3, 'City must be at leasat 3 characters'),
  postalCode: z.string().min(3, 'Postal code must be at leasat 3 characters'),
  country: z.string().min(3, 'Country must be at leasat 3 characters'),
...
export const insertOrderItemSchame = z.object({
  productId: z.string(),
  slug: z.string(),
  image: z.string(),
  name: z.string(),
